...
4. Write new software. Every Pi network boots. In 2019 I had Oracle Linux 7 running on the entire cluster but did it still work, did we have all the source code, MAC addresses and everything needed to do it again. In [A Temporal History of The World's Largest Raspberry Pi Cluster](https://medium.com/chrisbensen/a-temporal-history-of-the-worlds-largest-raspberry-pi-cluster-that-we-know-of-4e4b1e214bdd)
